...
(function (A) {
  ...
  const ENEMIES = [
    ...
    { id:'rata', name:'Rata', icon:'🐀', family:['beast'], category:'weak', tier:1, tags:['small'], biome:['village','forest','crypt'],
      health:6, damage:'1d3', difficulty:7, armor:0, speed:14, coinLoot:[0,2], drops:[], regions:['bosque_sombrio','cementerio'], spawn:{min:1,max:5,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'rata_gigante', name:'Rata gigante', icon:'🐀', family:['beast'], category:'normal', tier:2, tags:['poison'], biome:['forest','crypt','swamp'],
      health:14, damage:'1d6', difficulty:8, armor:0, speed:11, coinLoot:[1,4], drops:[], regions:['bosque_sombrio','cementerio','pantano'], spawn:{min:1,max:4,weight:1,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'gato', name:'Gato salvaje', icon:'🐈‍⬛', family:['beast'], category:'weak', tier:1, tags:['small','agile'], biome:['village','forest'],
      health:8, damage:'1d3', difficulty:8, armor:0, speed:13, coinLoot:[0,1], drops:[], regions:['bosque_sombrio'], spawn:{min:1,max:3,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'perro_salvaje', name:'Perro salvaje', icon:'🐕', family:['beast'], category:'weak', tier:1, tags:[], biome:['village','plains','forest'],
      health:10, damage:'1d4', difficulty:8, armor:0, speed:11, coinLoot:[0,2], drops:[], regions:['bosque_sombrio','camino_real'], spawn:{min:1,max:3,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'cuervo', name:'Cuervo', icon:'🐦', family:['beast','flying'], category:'weak', tier:1, tags:['flying'], biome:['graveyard','plains'],
      health:5, damage:'1d3', difficulty:9, armor:0, speed:15, coinLoot:[0,1], drops:[], regions:['cementerio'], spawn:{min:1,max:5,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'buho', name:'Búho', icon:'🦉', family:['beast','flying'], category:'weak', tier:1, tags:['flying'], biome:['forest'],
      health:7, damage:'1d3', difficulty:9, armor:0, speed:12, coinLoot:[0,1], drops:[], regions:['bosque_sombrio'], spawn:{min:1,max:3,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'halcon', name:'Halcón', icon:'🦅', family:['beast','flying'], category:'weak', tier:2, tags:['flying','agile'], biome:['mountain','plains'],
      health:9, damage:'1d4', difficulty:10, armor:0, speed:14, coinLoot:[0,2], drops:[], regions:['camino_real','montanas'], spawn:{min:1,max:3,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'aguila', name:'Águila', icon:'🦅', family:['beast','flying'], category:'normal', tier:3, tags:['flying'], biome:['mountain'],
      health:18, damage:'1d6+1', difficulty:11, armor:0, speed:16, coinLoot:[1,3], drops:[], regions:['montanas'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'serpiente', name:'Serpiente', icon:'🐍', family:['beast'], category:'weak', tier:2, tags:['poison'], biome:['forest','swamp','desert'],
      health:8, damage:'1d4', difficulty:9, armor:0, speed:8, coinLoot:[0,2], drops:[], regions:['bosque_sombrio','pantano','desierto'], spawn:{min:1,max:3,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'arana', name:'Araña', icon:'🕷️', family:['insect'], category:'weak', tier:1, tags:['poison','small'], biome:['cave','crypt','forest'],
      health:7, damage:'1d3', difficulty:9, armor:0, speed:11, coinLoot:[0,1], drops:[], regions:['bosque_sombrio','cuevas_ancestrales','catacumbas'], spawn:{min:1,max:4,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'murcielago', name:'Murciélago', icon:'🦇', family:['beast','flying'], category:'weak', tier:1, tags:['flying','small'], biome:['cave','crypt'],
      health:5, damage:'1d3', difficulty:10, armor:0, speed:13, coinLoot:[0,1], drops:[], regions:['cuevas_ancestrales','catacumbas','cementerio'], spawn:{min:1,max:6,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'zorro', name:'Zorro', icon:'🦊', family:['beast'], category:'weak', tier:1, tags:['agile'], biome:['forest','plains'],
      health:9, damage:'1d3', difficulty:9, armor:0, speed:12, coinLoot:[0,2], drops:[], regions:['bosque_sombrio'], spawn:{min:1,max:3,weight:2,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'jabali', name:'Jabalí', icon:'🐗', family:['beast'], category:'normal', tier:2, tags:['charge'], biome:['forest','plains'],
      health:18, damage:'1d6+1', difficulty:9, armor:1, speed:12, coinLoot:[1,3], drops:[], regions:['bosque_sombrio','camino_real'], spawn:{min:1,max:3,weight:1,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'tortuga', name:'Tortuga gigante', icon:'🐢', family:['beast'], category:'normal', tier:2, tags:['armor'], biome:['swamp','coast'],
      health:22, damage:'1d4', difficulty:7, armor:3, speed:5, coinLoot:[1,3], drops:[], regions:['pantano'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'lobo', name:'Lobo', icon:'🐺', family:['beast'], category:'normal', tier:2, tags:['pack'], biome:['forest','mountain'],
      health:15, damage:'1d6', difficulty:9, armor:0, speed:13, coinLoot:[1,3], drops:[], regions:['bosque_sombrio','camino_real','montanas'], spawn:{min:1,max:6,weight:1,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'oso', name:'Oso', icon:'🐻', family:['beast'], category:'strong', tier:4, tags:[], biome:['forest','mountain'],
      health:50, damage:'2d4+1', difficulty:11, armor:2, speed:8, coinLoot:[3,8], drops:[], regions:['bosque_sombrio','montanas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'esqueleto', name:'Esqueleto', icon:'💀', family:['undead'], category:'normal', tier:2, tags:[], biome:['crypt','graveyard'],
      health:14, damage:'1d6', difficulty:9, armor:1, speed:8, coinLoot:[1,4], drops:[], regions:['cementerio','catacumbas'], spawn:{min:1,max:4,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'zombi', name:'Zombi', icon:'🧟', family:['undead'], category:'normal', tier:2, tags:['slow'], biome:['crypt','graveyard'],
      health:18, damage:'1d6', difficulty:8, armor:0, speed:6, coinLoot:[0,3], drops:[], regions:['cementerio'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'escorpion', name:'Escorpión', icon:'🦂', family:['insect'], category:'normal', tier:3, tags:['poison'], biome:['desert','cave'],
      health:18, damage:'1d6+1', difficulty:10, armor:1, speed:9, coinLoot:[1,4], drops:[], regions:['desierto','cuevas_ancestrales'], spawn:{min:1,max:4,weight:1,groupable:true}, tameable:true, tameItem:'carne_cruda', autoLoot:true },
    ...
    { id:'fantasma', name:'Fantasma', icon:'👻', family:['undead','spirit'], category:'normal', tier:4, tags:['ethereal'], biome:['graveyard','crypt','ruins'],
      health:24, damage:'1d8+1', difficulty:13, armor:0, speed:14, coinLoot:[2,6], drops:[], regions:['cementerio','catacumbas'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'necrofago', name:'Necrófago', icon:'🧟', family:['undead'], category:'normal', tier:4, tags:['disease'], biome:['crypt','graveyard'],
      health:36, damage:'2d4', difficulty:11, armor:1, speed:7, coinLoot:[3,8], drops:[], regions:['cementerio','catacumbas'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'banshee', name:'Banshee', icon:'🌬️', family:['undead','spirit'], category:'strong', tier:5, tags:['scream','ethereal'], biome:['graveyard','crypt'],
      health:40, damage:'2d6+1', difficulty:13, armor:0, speed:12, coinLoot:[4,10], drops:[], regions:['catacumbas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'gargola', name:'Gárgola', icon:'🗿', family:['construct','flying'], category:'strong', tier:5, tags:['stone','flying'], biome:['ruins','arcane'],
      health:50, damage:'2d6', difficulty:11, armor:5, speed:9, coinLoot:[5,12], drops:[], regions:['ruinas_perdidas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'arpia', name:'Arpía', icon:'🦅', family:['humanoid','flying'], category:'normal', tier:4, tags:['flying'], biome:['mountain'],
      health:30, damage:'1d8+1', difficulty:12, armor:1, speed:13, coinLoot:[3,8], drops:[], regions:['montanas'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'cangrejo', name:'Cangrejo gigante', icon:'🦀', family:['marine','aquatic'], category:'normal', tier:4, tags:['armor','aquatic'], biome:['coast','sea'],
      health:36, damage:'1d8+1', difficulty:9, armor:5, speed:6, coinLoot:[3,8], drops:[], regions:['puerto','alta_mar'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:true, tameItem:'pescado_fresco', autoLoot:true },

    // ============================================================
    // TIER 5-6: peligrosos
    // ============================================================
    { id:'tiburon', name:'Tiburón', icon:'🦈', family:['marine','aquatic'], category:'strong', tier:6, tags:['aquatic'], biome:['sea'],
      health:65, damage:'2d8', difficulty:11, armor:2, speed:13, coinLoot:[6,15], drops:[], regions:['alta_mar'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:true, tameItem:'pescado_fresco', autoLoot:true },
    ...
    { id:'ettin', name:'Ettin', icon:'👹', family:['humanoid','giant'], category:'strong', tier:6, tags:['heavy'], biome:['mountain'],
      health:95, damage:'2d8+1', difficulty:11, armor:3, speed:7, coinLoot:[10,20], drops:[], regions:['montanas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'drow', name:'Drow', icon:'🧝‍♂️', family:['humanoid','arcane'], category:'normal', tier:5, tags:['agile','poison'], biome:['cave'],
      health:48, damage:'2d6+1', difficulty:13, armor:2, speed:12, coinLoot:[8,18], drops:[], regions:['cuevas_ancestrales'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'driade', name:'Dríade', icon:'🌳', family:['plant','spirit'], category:'normal', tier:5, tags:['nature','charm'], biome:['forest'],
      health:50, damage:'2d6', difficulty:12, armor:1, speed:10, coinLoot:[6,14], drops:[], regions:['bosque_sombrio'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'ent', name:'Ent', icon:'🌲', family:['plant'], category:'strong', tier:6, tags:['nature','heavy'], biome:['forest'],
      health:100, damage:'2d8', difficulty:10, armor:5, speed:5, coinLoot:[8,18], drops:[], regions:['bosque_sombrio'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'vampiro', name:'Vampiro', icon:'🧛', family:['undead','humanoid'], category:'strong', tier:7, tags:['drain'], biome:['crypt','graveyard'],
      health:110, damage:'3d6+2', difficulty:14, armor:3, speed:12, coinLoot:[15,30], drops:[], regions:['catacumbas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'elem_hielo', name:'Elemental de hielo', icon:'❄️', family:['elemental'], category:'strong', tier:7, tags:['ice','arcane'], biome:['mountain','arcane'],
      health:120, damage:'3d6+1', difficulty:12, armor:4, speed:8, coinLoot:[12,24], drops:[{itemId:'mat_gema_arcana',chance:0.4},{itemId:'pergamino_rayo_helado',chance:0.2}], regions:['montanas','ruinas_perdidas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'elem_fuego', name:'Elemental de fuego', icon:'🔥', family:['elemental'], category:'strong', tier:7, tags:['fire','arcane'], biome:['volcano','arcane'],
      health:115, damage:'3d8', difficulty:12, armor:3, speed:10, coinLoot:[12,24], drops:[{itemId:'mat_gema_arcana',chance:0.4},{itemId:'pergamino_llama',chance:0.2}], regions:['volcan','ruinas_perdidas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'elem_arcano', name:'Elemental arcano', icon:'✨', family:['elemental','arcane'], category:'strong', tier:7, tags:['arcane','magic'], biome:['arcane','ruins'],
      health:105, damage:'3d8', difficulty:14, armor:2, speed:11, coinLoot:[14,28], drops:[{itemId:'mat_gema_arcana',chance:0.6},{itemId:'pergamino_chispa',chance:0.25}], regions:['ruinas_perdidas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'golem', name:'Gólem', icon:'🗿', family:['construct'], category:'strong', tier:7, tags:['stone','heavy'], biome:['ruins','cave'],
      health:140, damage:'3d6', difficulty:11, armor:7, speed:6, coinLoot:[10,22], drops:[], regions:['ruinas_perdidas','cuevas_ancestrales'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'golem_lava', name:'Gólem de lava', icon:'🌋', family:['construct','elemental'], category:'strong', tier:8, tags:['fire','heavy'], biome:['volcano'],
      health:160, damage:'3d8+1', difficulty:12, armor:6, speed:6, coinLoot:[14,28], drops:[], regions:['volcan'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'serp_marina', name:'Serpiente marina', icon:'🐍', family:['marine','aquatic'], category:'strong', tier:7, tags:['aquatic','poison'], biome:['sea','abyss'],
      health:130, damage:'3d6+2', difficulty:13, armor:3, speed:11, coinLoot:[14,28], drops:[], regions:['alta_mar'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'tentaculo', name:'Tentáculo', icon:'🐙', family:['marine','aquatic'], category:'normal', tier:7, tags:['aquatic','grab'], biome:['sea','abyss'],
      health:90, damage:'3d6', difficulty:13, armor:1, speed:9, coinLoot:[10,22], drops:[], regions:['alta_mar','abismo_marino'], spawn:{min:1,max:2,weight:1,groupable:true}, tameable:false, autoLoot:true },

    { id:'manticora', name:'Mantícora', icon:'🦁', family:['beast','flying'], category:'strong', tier:7, tags:['flying','poison'], biome:['mountain','desert'],
      health:120, damage:'3d6+2', difficulty:13, armor:3, speed:12, coinLoot:[14,28], drops:[], regions:['montanas','desierto'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'quimera', name:'Quimera', icon:'🐲', family:['beast','flying'], category:'strong', tier:8, tags:['fire','flying'], biome:['mountain','volcano'],
      health:155, damage:'4d6', difficulty:14, armor:4, speed:11, coinLoot:[16,32], drops:[], regions:['montanas','volcan'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:true, tameItem:'carne_cruda', autoLoot:true },

    { id:'medusa', name:'Medusa', icon:'🐍', family:['humanoid'], category:'strong', tier:7, tags:['petrify'], biome:['ruins','crypt'],
      health:90, damage:'3d6+1', difficulty:14, armor:2, speed:10, coinLoot:[14,28], drops:[], regions:['ruinas_perdidas','catacumbas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'ciclope', name:'Cíclope', icon:'👁️', family:['humanoid','giant'], category:'strong', tier:8, tags:['heavy'], biome:['mountain','cave'],
      health:170, damage:'4d6', difficulty:12, armor:4, speed:7, coinLoot:[16,32], drops:[], regions:['montanas','cuevas_ancestrales'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'dragon_joven', name:'Dragón joven', icon:'🐲', family:['dragon','flying'], category:'strong', tier:8, tags:['fire','flying'], biome:['mountain','lair'],
      health:175, damage:'4d8+1', difficulty:14, armor:5, speed:12, coinLoot:[20,40], drops:[], regions:['nido_de_dragones','volcan'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:true, tameItem:'carne_cruda', autoLoot:true },
    ...
    { id:'aparicion', name:'Aparición', icon:'👻', family:['undead','spirit'], category:'strong', tier:8, tags:['ethereal','fear'], biome:['crypt','graveyard'],
      health:115, damage:'3d8+1', difficulty:15, armor:0, speed:13, coinLoot:[15,30], drops:[], regions:['catacumbas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'naga', name:'Naga', icon:'🧜', family:['humanoid','aquatic'], category:'strong', tier:7, tags:['aquatic','poison'], biome:['swamp','sea'],
      health:115, damage:'3d6+2', difficulty:14, armor:3, speed:10, coinLoot:[14,28], drops:[], regions:['alta_mar','pantano'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'contemplador', name:'Contemplador', icon:'👁️', family:['arcane'], category:'strong', tier:8, tags:['magic','flying'], biome:['cave','arcane'],
      health:140, damage:'4d6', difficulty:15, armor:3, speed:9, coinLoot:[18,35], drops:[{itemId:'mat_gema_arcana',chance:0.5},{itemId:'pergamino_bola_fuego',chance:0.2}], regions:['cuevas_ancestrales','ruinas_perdidas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'cab_muerte', name:'Caballero de la muerte', icon:'☠️', family:['undead','humanoid'], category:'strong', tier:8, tags:['heavy','undead'], biome:['crypt','graveyard'],
      health:170, damage:'4d6', difficulty:14, armor:6, speed:8, coinLoot:[18,36], drops:[], regions:['catacumbas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },

    { id:'sucubo', name:'Súcubo', icon:'😈', family:['demon','flying'], category:'strong', tier:7, tags:['charm','flying'], biome:['hell','ruins'],
      health:100, damage:'3d6+2', difficulty:14, armor:2, speed:13, coinLoot:[15,30], drops:[], regions:['ruinas_perdidas','infierno'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'brightwing', name:'Brightwing', icon:'🐉', family:['dragon','arcane','flying'], category:'strong', tier:6, tags:['magic','flying'], biome:['arcane'],
      health:140, damage:'3d8', difficulty:14, armor:4, speed:13, coinLoot:[25,50], drops:[{itemId:'mat_escama_dragon',chance:0.6},{itemId:'mat_sangre_dragon',chance:0.4},{itemId:'pergamino_chispa',chance:0.3}], regions:['torre_del_mago','ruinas_perdidas'], spawn:{min:1,max:1,weight:0.6,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'dragon_anciano', name:'Dragón anciano', icon:'🐲', family:['dragon','flying','legendary'], category:'boss', tier:10, tags:['fire','flying','ancient'], biome:['lair','volcano'],
      health:380, damage:'7d10+0', difficulty:16, armor:7, speed:7, coinLoot:[100,200], drops:[{itemId:'mat_escama_dragon',chance:0.9},{itemId:'mat_sangre_dragon',chance:0.85},{itemId:'pergamino_aliento_dragon',chance:0.3},{itemId:'item_bag_advanced',chance:0.5}], regions:['nido_de_dragones'], spawn:{min:1,max:1,weight:0.1,groupable:false}, tameable:false, autoLoot:true },
    ...
    { id:'hidra', name:'Hidra', icon:'🐍', family:['beast','aquatic'], category:'boss', tier:9, tags:['regen','poison'], biome:['swamp'],
      health:300, damage:'5d10+2', difficulty:15, armor:4, speed:9, coinLoot:[70,140], drops:[], regions:['pantano'], spawn:{min:1,max:1,weight:0.3,groupable:false}, tameable:true, tameItem:'pescado_fresco', autoLoot:true },

    { id:'titan', name:'Titán', icon:'⚔️', family:['humanoid','giant','legendary'], category:'boss', tier:10, tags:['ancient','heavy'], biome:['mountain'],
      health:400, damage:'7d10+0', difficulty:14, armor:8, speed:8, coinLoot:[100,200], drops:[], regions:['montanas','ruinas_perdidas'], spawn:{min:1,max:1,weight:0.1,groupable:false}, tameable:false, autoLoot:true },

    { id:'tarrasca', name:'Tarrasca', icon:'🦖', family:['beast','legendary'], category:'boss', tier:10, tags:['ancient','heavy'], biome:['cave','volcano'],
      health:450, damage:'7d10+3', difficulty:14, armor:9, speed:7, coinLoot:[120,250], drops:[], regions:['cuevas_ancestrales','volcan'], spawn:{min:1,max:1,weight:0.1,groupable:false}, tameable:false, autoLoot:true },
  ];
