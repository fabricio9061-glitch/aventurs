...
(function (A) {
  ...
  const ARMORS = [
    ...
    { id:'cota_de_malla', name:'Cota de malla', type:'armor', icon:'⛓️', defense:3, value:200, rarity:'uncommon', tier:4, weight:5, magic:false,
    ...
    { id:'armadura_placas', name:'Armadura de placas', type:'armor', icon:'🛡️', defense:5, value:500, rarity:'rare', tier:6, weight:8, magic:false,
    ...
    { id:'placa_dragon', name:'Placa de dragón', type:'armor', icon:'🐲', defense:8, value:2000, rarity:'legendary', tier:10, weight:7, magic:true,
