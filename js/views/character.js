          ...
          <div class="char-form">
            ...
            <div class="char-actions">
              <button class="btn-primary" id="btn-create"
                      ${!selectedRaceId ? 'disabled' : ''}>
                Comenzar aventura
              </button>
              ${selectedRaceId && !inputName.trim() ? `<div class="dim small" style="text-align:center;margin-top:6px">Si dejás el nombre vacío, se asignará uno al azar.</div>` : ''}
            </div>
          </div>
        </div>
      </div>
